...
def calculate_text_similarity(text1, text2):
    ...
    def normalize_text(text):
        """normalize_text removes pause-tag tokens, converts text to lowercase, and splits it into a list of words. Returns a set of unique words."""
        # Strip pause-tag tokens so they don't affect the similarity score
